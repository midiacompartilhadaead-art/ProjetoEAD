...
export const POLOS_LIST = [
  'Apodi', 'Araçatuba', 'Assis', 'Bauru', 'Belo Horizonte', 'Botucatu',
  'Buritirama', 'Campinas', 'Canela', 'Cariacica', 'Cuiabá', 'Curitiba',
  'Dracena', 'Garça', 'Gravataí', 'Indaiatuba', 'Itaboraí', 'Itanhaém',
  'João Pessoa', 'Juiz de Fora', 'Lins', 'Lucélia', 'Marília', 'Medianeira',
  'Ourinhos', 'Paraguaçu Paulista', 'Peruíbe', 'Presidente Prudente', 'Quatá',
  'Ribeirão Cascalheira', 'Ribeirão Preto', 'São José', 'São José dos Campos',
  'São Paulo', 'Serra', 'Sorocaba', 'Tupã', 'Uberlândia'
];
